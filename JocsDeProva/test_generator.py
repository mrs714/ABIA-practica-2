...
config_range = 1
level = [3 for i in range(config_range)]
num_books = [40 + i for i in range(config_range)]
domain = "books"
predecessor_chance = [0.5 for i in range(config_range)] # Chance of a book having a predecesor - level 0
parallel_chance = [0.15 for i in range(config_range)] # Chance of a book having a parallel - level 2
