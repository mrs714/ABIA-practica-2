(define (problem test0_64)
    ...
    (:init
        ...
        (predecessor book64 book25)
        (predecessor book26 book61)
        (predecessor book29 book46)
        (predecessor book42 book31)
        (predecessor book48 book32)
        (predecessor book35 book44)
        (predecessor book38 book54)
        (predecessor book56 book47)
        (predecessor book59 book50)
        (predecessor book52 book71)
        (predecessor book65 book53)
        (predecessor book53 book58)
        (predecessor book66 book73)
        (read book3)
        (read book5)
        (read book7)
        (read book8)
