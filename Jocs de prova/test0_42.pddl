(define (problem test0_42)
    ...
    (:init
        ...
        (predecessor book14 book51)
        (predecessor book19 book39)
        (predecessor book27 book21)
        (predecessor book32 book22)
        (predecessor book29 book23)
        (predecessor book23 book48)
        (predecessor book31 book35)
        (predecessor book47 book34)
        (predecessor book35 book46)
        (predecessor book42 book44)
        (read book34)
        (read book35)
        (read book3)
        (read book2)
