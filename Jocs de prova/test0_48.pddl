(define (problem test0_48)
    ...
    (:init
        ...
        (predecessor book15 book53)
        (predecessor book20 book40)
        (predecessor book57 book21)
        (predecessor book29 book23)
        (predecessor book24 book49)
        (predecessor book46 book32)
        (predecessor book32 book48)
        (predecessor book52 book34)
        (predecessor book40 book45)
        (predecessor book44 book55)
        (predecessor book53 book56)
        (read book2)
        (read book3)
        (read book4)
        (read book36)
