(define (problem test0_69)
    ...
    (:init
        ...
        (predecessor book24 book63)
        (predecessor book51 book25)
        (predecessor book43 book31)
        (predecessor book33 book38)
        (predecessor book34 book56)
        (predecessor book72 book44)
        (predecessor book59 book46)
        (predecessor book52 book47)
        (predecessor book47 book53)
        (predecessor book76 book48)
        (predecessor book48 book70)
        (predecessor book50 book58)
        (predecessor book61 book54)
        (predecessor book63 book73)
        (predecessor book64 book74)
        (predecessor book74 book77)
        (read book4)
        (read book6)
        (read book11)
        (read book14)
