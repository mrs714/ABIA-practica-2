(define (problem test0_86)
    ...
    (:init
        ...
        (predecessor book5 book84)
        (predecessor book57 book6)
        (predecessor book12 book7)
        (predecessor book7 book78)
        ...
        (predecessor book21 book68)
        (predecessor book55 book24)
        (predecessor book24 book75)
        (predecessor book51 book25)
        (predecessor book25 book50)
        (predecessor book30 book81)
        ...
        (predecessor book44 book70)
        (predecessor book58 book45)
        (predecessor book50 book56)
        (predecessor book76 book53)
        (predecessor book53 book65)
        (predecessor book90 book54)
        (predecessor book61 book85)
        (predecessor book86 book66)
        (predecessor book80 book67)
        (predecessor book74 book73)
        (predecessor book73 book92)
        (predecessor book89 book94)
        (read book0)
        (read book2)
        (read book13)
        (read book14)
