(define (problem test0_71)
    ...
    (:init
        ...
        (predecessor book35 book54)
        (predecessor book40 book47)
        (predecessor book72 book44)
        (predecessor book59 book46)
        (predecessor book48 book68)
        (predecessor book53 book79)
        (predecessor book78 book56)
        (predecessor book58 book71)
        (predecessor book68 book76)
