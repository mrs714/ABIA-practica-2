(define (problem test0_63)
    ...
    (:init
        ...
        (predecessor book65 book54)
        (predecessor book54 book58)
        (read book8)
        (read book14)
        (read book17)
        (read book18)
