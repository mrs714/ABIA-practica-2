(define (problem test0_62)
    ...
    (:init
        ...
        (predecessor book5 book24)
        (predecessor book57 book6)
        (predecessor book6 book70)
        (predecessor book12 book7)
        (predecessor book69 book8)
        (predecessor book62 book14)
        (predecessor book16 book40)
        (predecessor book23 book17)
        (predecessor book22 book20)
        (predecessor book54 book21)
        (predecessor book28 book25)
        (predecessor book26 book63)
        (predecessor book30 book48)
        (predecessor book43 book33)
        (predecessor book49 book34)
        (predecessor book37 book46)
        (predecessor book39 book58)
        (predecessor book56 book50)
        (predecessor book59 book51)
        (predecessor book52 book71)
        (predecessor book53 book60)
        (predecessor book64 book55)
        (read book8)
        (read book14)
        (read book16)
        (read book17)
